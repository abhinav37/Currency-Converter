...
class HomePresenterTest {
    ...
    private val dispatcher = object : DispatchersFactory {
    ...
    private val mockRemoteDataList: List<CurrencyRate> = listOf(CurrencyRate(1, "", 0F))
    ...
    fun setUp() {
        ...
        presenter = spy(HomePresenter(mockViewProxy, mockRepository, dispatcher))
